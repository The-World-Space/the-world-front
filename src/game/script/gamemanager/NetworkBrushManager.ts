...
export class NetworkBrushManager extends Component {
    ...
    private updateCollider(x: number, y: number, isBlocked: boolean): void {
    ...
    private updateImageGameObject(x: number, y: number): Promise<FetchResult> {
        if (!this._worldId) throw new Error("no world id");
    ...
    private deleteAtlasTile(x: number, y: number): void {
        if (!this._worldId) throw new Error("no world id");
        if (!this._protoClient) throw new Error("no proto client");
    ...
    private deleteIframeObject(x: number, y: number): void {
        if (!this._worldId) throw new Error("no world id");
        if (!this._protoClient) throw new Error("no proto client");
    ...
    private deleteImageObject(x: number, y: number): Promise<FetchResult> {
        if (!this._worldId) throw new Error("no world id");
        if (!this._apolloClient) throw new Error("no apollo client");
        return this._apolloClient.mutate({
            mutation: gql`
    ...
    private createIframeGameObject(x: number, y: number): void {
