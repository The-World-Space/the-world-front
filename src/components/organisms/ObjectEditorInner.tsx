...
function ObjectEditorInner({ apolloClient, worldId, opened, datas }: PropsType) {
    return (
...
function PhotoElement({ onSelect, selected, data }: PhotoElementProps) {
...
export default ObjectEditorInner;
